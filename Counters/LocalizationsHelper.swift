...
struct Localizations {
    static var detailViewNavBarTitleEdit: LocalizedStringKey {
        return "detailView.navBarTitle.edit"
    }
    
    static var detailViewNavBarTitleAdd: LocalizedStringKey {
        return "detailView.navBarTitle.add"
    }
    
    static var detailViewNavBarButtonsDone: LocalizedStringKey {
    ...
    static var detailViewCounterStepLabel: String {
